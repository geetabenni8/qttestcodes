...
unix:!macx: LIBS += -L$$PWD/../../../build-SMTPEmail-Desktop-Debug/ -lSMTPEmail

INCLUDEPATH += $$PWD/../../../build-SMTPEmail-Desktop-Debug
DEPENDPATH += $$PWD/../../../build-SMTPEmail-Desktop-Debug
